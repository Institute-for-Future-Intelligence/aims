...
export const i18n_zh_cn = {
  translation: {
    ...
    message: {
      FailInGeneratingMolecule: '生成分子失败。请再试一下。点击我关闭。',
    ...
    experiment: {
      ...
      TemperatureSettings: '温度设定',
      Temperature: '温度',
      ConstantPressure: '恒压',
      PressureSettings: '压力设定',
      Pressure: '压力',
      Protein: '蛋白质',
      Ligand: '配体',
      Molecules: '分子',
    ...
    projectPanel: {
      ...
      NumberOfColumns: '列数',
      FindMoleculesMostSimilarToSelectedOneToImportIntoGallery: '从内建数据库里查找最类似选中分子的其它分子输入到图库',
      MostSimilarMolecules: '最类似于',
      Descriptor: '描述符',
      LevenshteinDistance: '莱文斯坦距离',
      SelectMoleculeToImportIntoGallery: '从内建数据库里选择分子输入到图库',
      SelectMoleculeFromInternalDatabase: '从内建数据库里选择一个分子',
