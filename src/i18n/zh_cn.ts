...
export const i18n_zh_cn = {
  translation: {
    ...
    experiment: {
      ...
      Information: '信息',
      MoveInPositiveXDirection: '沿着X轴正方向平移',
      MoveInNegativeXDirection: '沿着X轴负方向平移',
      MoveInPositiveYDirection: '沿着Y轴正方向平移',
      MoveInNegativeYDirection: '沿着Y轴负方向平移',
      MoveInPositiveZDirection: '沿着Z轴正方向平移',
      MoveInNegativeZDirection: '沿着Z轴负方向平移',
