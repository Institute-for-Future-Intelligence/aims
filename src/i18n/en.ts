...
export const i18n_en = {
  translation: {
    ...
    aboutUs: {
      ...
      FundingInformation:
        'The National Institutes of Health (NIH) generously provides funding for the research and development of this product through grants R25GM150143. Any opinions, findings, and conclusions or recommendations expressed in this product, however, are those of the authors and do not necessarily reflect the views of NIH. We thank Dylan Bulseco, Kent Crippen, William Furiosi, Jason Ravitz, and Minji Yun for their important feedback and suggestions.',
    ...
    message: {
      ...
      GeneratingAMoleculeMayTakeAWhile:
        'Generating a molecule may take a long time and cannot be cancelled. The result is limited to molecules that have less than 1,000 atoms. Think about your prompt carefully before pressing OK.',
      GeneratedResultNotAccepted: 'Sorry, the generated result is not accepted. Click me to close.',
      RevisionNotAccepted: 'Sorry, the revision is not accepted.',
    ...
    experiment: {
      ExternalFields: 'External Fields',
    ...
    projectPanel: {
      ...
      SetMinimumFiltersToPassAllData: 'Set Minimum Filters That Let All Data Pass',
      ...
      FindMoleculesMostSimilarToSelectedOneToImportIntoGallery:
        'Find molecules in the internal database most similar to the selected one to import into gallery',
      MostSimilarMolecules: 'Molecules Most Similar to',
      Descriptor: 'Descriptor',
      LevenshteinDistance: 'Levenshtein Distance',
      SelectMoleculeToImportIntoGallery: 'Select a molecule from the internal dabase to import into gallery',
      SelectMoleculeFromInternalDatabase: 'Select a Molecule from the Internal Database',
      GenerateMolecule: 'Generate a molecule using AI',
