...
export const i18n_en = {
  translation: {
    ...
    experiment: {
      ...
      MoveInPositiveXDirection: 'Move in positive X direction',
      MoveInNegativeXDirection: 'Move in negative X direction',
      MoveInPositiveYDirection: 'Move in positive Y direction',
      MoveInNegativeYDirection: 'Move in negative Y direction',
      MoveInPositiveZDirection: 'Move in positive Z direction',
      MoveInNegativeZDirection: 'Move in negative Z direction',
