...
export const i18n_zh_tw = {
  translation: {
    ...
    experiment: {
      ...
      Information: '資訊',
      MoveInPositiveXDirection: '沿著X軸正方向平移',
      MoveInNegativeXDirection: '沿著X軸負方向平移',
      MoveInPositiveYDirection: '沿著Y軸正方向平移',
      MoveInNegativeYDirection: '沿著Y軸負方向平移',
      MoveInPositiveZDirection: '沿著Z軸正方向平移',
      MoveInNegativeZDirection: '沿著Z軸負方向平移',
