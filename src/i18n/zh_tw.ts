...
export const i18n_zh_tw = {
  translation: {
    ...
    aboutUs: {
      ...
      Acknowledgment: '鳴謝',
      FundingInformation:
        '本產品的研發承蒙美國國立衛生研究院慷慨資助（項目號R25GM150143）。本產品的任何觀點或結論僅代表創作者個人意見。Dylan Bulseco，Kent Crippen，William Furiosi，Jason Ravitz和Minji Yun在本產品研發過程中提供重要協助，在此一併感謝。',
    ...
    message: {
      ...
      GeneratingAMoleculeMayTakeAWhile: '生成一個分子可能需要一些時間且無法取消。按生成鍵前請仔細考慮好給AI的輸入。',
    ...
    menu: {
      ...
      examples: {
        ...
        chemistry: {
          ...
          ArketamineVsEsketamine: '氯胺酮的對映異構',
